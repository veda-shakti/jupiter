...
function App()
{
    ...
    useEffect(() => {
        ...
        function handleScroll(direction) 
        {
            ...
            if (currentFrame.id === "content12" && direction==="down" && !shouldswitch ){
            ...
            else 
            {
                ...
                if (currentFrame.id === "content12" && direction==="up" && !animating) {
                    shouldswitch=false
        ...
        async function switchbg (index,direction) {
            ...
            const isbg2 = index >= 3 && index < 5;
            const isPhone1 = index >= 1;
            const isPhone2 = index > 7 && index!== 11  ;
            const isbg3 = index >= 5 && index < 7;
            const isFullWidth = index === 7;
            const isbg4 = index >= 8 && index < 10;
            const isbg5 =  index === 10;
    ...
    return (
        <div className="App">
            ...
            <ModalContext.Provider value={{ showModal, setShowModal }}>
                <Meta/>
                <BackgroundBox bg="cosmos" bgtype={bgtypebg}>
